...
class Category(models.Model):
    name = models.CharField(max_lenght=80, unique=True)
...
class Product(models.Model):
   class Product(models.Model):
    sku = models.CharField("Артикул / OEM", max_length=100, unique=True)
    name = models.CharField(max_length=255)
    ...
    description = models.TextField(blank=True, null=True)
    photo = models.URLField("Фото", max_length=500, blank=True, null=True)
    car_models = models.ManyToManyField("CarModel", related_name="products", blank=True)
...
class Order(models.Model):
    ...
    address = models.CharField("Адрес/пункт выдачи", max_length=255)
